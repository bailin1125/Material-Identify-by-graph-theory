...
int main(int argc, const char * argv[]) {
    ...
    double max2=0;
    double temp;
	char name1[200] = "O2Pb1_0.config", name2[200] = "AgF2.config", name4[5];
    for (i=0;i<argc;i++)
    {
        if (i==1)
        {
	...
	strcpy(name3, "rule_noorg_for_pc_2.txt");

	/*name1 = "41392-0_2d.config";
	name2 = "41392-1_2d.config";*/
	//cell cell_a("41392-0_2d.config");
	//cell cell_b("41392-1_2d.config");
